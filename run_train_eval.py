...
train_dir = os.path.join("","data","2_augmented_v05","train")
val_dir = os.path.join("","data","2_augmented_v05","val")
test_dir = os.path.join("","data","2_augmented_v05","test")
...
train_dataset, val_dataset, test_dataset = load_datasets(train_dir, val_dir, test_dir)
...
plt.plot(acc_dict['test'], label='test')
